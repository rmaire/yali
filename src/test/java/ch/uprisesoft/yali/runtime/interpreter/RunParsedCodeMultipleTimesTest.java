 ...
 */
//@Disabled
public class RunParsedCodeMultipleTimesTest {
    ...
    public RunParsedCodeMultipleTimesTest() {
    }
    ...
    @Test
    public void testRunParsedCode() {
        Node make1 = it.read("make \"testvar \"Hello");
        Node make2 = it.read("make \"testvar \"World!");
        Node printCode = it.read("print :testvar");
        ...
        assertThat(outputs.get(1), is("World!\n"));
    }
